...
package google.com.testanddel.VideoPlayback;
...
import google.com.testanddel.Constant;
import google.com.testanddel.SampleApplication.SampleAppRenderer;
import google.com.testanddel.SampleApplication.SampleAppRendererControl;
import google.com.testanddel.SampleApplication.SampleApplicationSession;
import google.com.testanddel.utils.SampleMath;
import google.com.testanddel.utils.SampleUtils;
import google.com.testanddel.utils.Texture;

import java.nio.Buffer;
import java.nio.ByteBuffer;
import java.nio.ByteOrder;
import java.util.Vector;
import google.com.testanddel.VideoPlayback.VideoPlayerHelper.*;
...
public class VideoPlaybackRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    ...
    VideoPlayerHelper.MEDIA_STATE currentStatus[] = new MEDIA_STATE[VideoPlayback.NUM_TARGETS];
    ...
    void initRendering()
    {
        ...
        keyframeQuadAspectRatio[VideoPlayback.ZHONGGUOYIDONG] = (float) mTextures
            .get(0).mHeight / (float) mTextures.get(0).mWidth;
        keyframeQuadAspectRatio[VideoPlayback.JIUZHAIGOU] = (float) mTextures.get(1).mHeight
    ...
    public void renderFrame(State state, float[] projectionMatrix)
    {
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++)
        {
            ...
            // calculation
            if (imageTarget.getName().compareTo(Constant.ZHONGGUOYIDONG) == 0)
                currentTarget = VideoPlayback.ZHONGGUOYIDONG;
            else
                currentTarget = VideoPlayback.JIUZHAIGOU;
        ...
        float[] textureCoordMatrix)
    {
        ...
        if (target == VideoPlayback.ZHONGGUOYIDONG)
        {
        ...
        } else if (target == VideoPlayback.JIUZHAIGOU)
        {
            tempUVMultRes = uvMultMat4f(
